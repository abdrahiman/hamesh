...
function ENAV() {
  return (
    ...
    >
      ...
      ></div>
      <div className="sc-fHxwqH kQhLuC flex items-center justify-between h-[46px]">
        <div className="ml-0 sm:ml-4 h-full flex items-center justify-start shrink-0"></div>
        <div className="flex items-center justify-start flex-grow mr-2 overflow-hidden shrink">
          <div className="documentTitle text-[16px] tracking-[-0.1px] leading-none px-1.5 py-1.5 rounded-md transition truncate select-none text-darkTextColor cursor-default ">
            ما هو JWT
          </div>
        </div>
