...
//   useEffect(() => {
//     if (article) {
//       if (JSON.parse(localStorage.getItem("editorData") || "[]")?.markdown)
//         return;
//       setEditorData({
//         title: article.title || "",
//         content: article.content || "",
...
//   }, [article]);
//   let handleUpdateDraft = async (isAuto: boolean = false) => {
//     const processedContent = await remark()
//       .use(html)
//       .process(editorData.markdown);
//     const contentHtml = processedContent.toString();
...
//             <div className="flex gap-4">
//               <button
//                 className="px-6 draft py-2 font-medium rounded-lg transition"
//                 onClick={() => handleUpdateDraft()}
//               >
//                 حفظ التعديل كمسودة
//               </button>
